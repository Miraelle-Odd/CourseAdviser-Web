        ...
        <div className="info-sections">
            ...
            <div className="info-section section-more-margin">
                <span className="title">
                    ...
                    <span className="parameter">IELTS, IELTS và Tiếng Anh văn phòng</span>
                </span>
...
const bonusTypes = [
    {
        ...
        infoContent: renderBonusContent({
            ...
            classDuration: 2,
            introParagraph: "Đây là khóa học cơ bản không hỗ trợ học cấp tốc và 1 kèm 1. Thời gian giàn trải không gấp gáp với chương trình học và kiến thức chất lượng tiêu chuẩn giúp các học viên tiếp thu hiệu quả theo châm ngôn mưa dầm thấm lâu. Các khóa học đều hoàn toàn đảm bảo về trình độ và kỹ năng cho học viên để đạt kết quả cao nhất khi làm bài thi IELTS.",
            multiplier: "1.0"
        })
    },
    {
